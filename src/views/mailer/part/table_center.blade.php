                ...
                <div class="dt-toolbar-footer">
                    <div class="col-sm-4 col-xs-12 hidden-xs">
                          <div id="dt_basic_info" class="dataTables_info" role="status" aria-live="polite">
                                {{__cms('Показано')}}
                              <span class="txt-color-darken listing_from">{{$allMails->getFrom()}}</span>
                                -
                              <span class="txt-color-darken listing_to">{{$allMails->getTo()}}</span>
                                {{__cms("из")}}
                              <span class="text-primary listing_total">{{$allMails->getTotal()}}</span>
                                {{__cms("записей")}}
                          </div>
                    </div>
